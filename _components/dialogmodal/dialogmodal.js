...
const Frdialogmodal = function ({
  ...
  function _addA11y (container) {
    let modal = q(modalSelector, container)[0];
  ...
  function _showModal (container, modal) {
    ...
    if (!isAlert) defer(_bindContainerPointer);
    //  reset scroll
    modal.scrollTop = 0;
    //  update style hook
