...
const Fraccordion = function ({
  ...
  let accordionContainers = q(selector);


  // A11Y
  function _addA11y (accordionContainer) {
    // get accordion elements
    const accordionHeaders = q(headerSelector, accordionContainer);
    const accordionPanels = q(panelSelector, accordionContainer);
  ...
  function _hideAllPanels (accordionContainer) {
    // get accordion elements
    const siblingHeaders = q(headerSelector, accordionContainer);
    const siblingPanels = q(panelSelector, accordionContainer);
  ...
  function _eventHeaderKeydown (e) {
    ...
    let theseHeaders = q(headerSelector, thisContainer);
